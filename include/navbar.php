    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link" href="#id02"><button type="button" class="btn btn-info" onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Sign In</button></a>
        </li>
        <li class="nav-item">
          <!-- <a class="nav-link" href="sign-up.html"><button type="button" class="btn btn-info">Sign Up</button></a> -->
          <a class="nav-link" href="#id01"><button type="button" class="btn btn-info" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Sign Up</button></a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="#id03"><button type="button" class="btn btn-info" onclick="document.getElementById('id03').style.display='block'" style="width:auto;" >Make Profile</button></a>
        </li>
